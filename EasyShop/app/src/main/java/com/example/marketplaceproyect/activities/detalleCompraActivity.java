...
public class detalleCompraActivity extends AppCompatActivity {
    ...
    private Button botonEscogerMedioDePago;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        botonEscogerMedioDePago.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                goActivities.goMediosDePago(producto,Integer.parseInt(stockParaComprar.getText().toString()));
    ...
    private void iniciarlizaVariables() {
        ...
        botonEscogerMedioDePago = findViewById(R.id.botonEscogerMedioDePago);
