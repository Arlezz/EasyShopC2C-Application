...
import com.example.marketplaceproyect.activities.mediosDePagoActivity;
...
public class goActivities extends AppCompatActivity {
    ...
    /*public void goBuscadorHome() {
        contexto.startActivity(new Intent(contexto, homeActivity.class).putExtra("buscador",1));
    }*/
    ...
    public void goMediosDePago(Products producto,int cantidadComprada){
        contexto.startActivity(new Intent(contexto, mediosDePagoActivity.class).putExtra("producto",producto).putExtra("cantidadComprada",cantidadComprada));
    }
